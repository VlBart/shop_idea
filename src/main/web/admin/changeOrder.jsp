                                    ...
                                    <div id="content-box-in-left">
                                            <div id="content-box-in-left-in">
                                                ...
                                                <h3>Текущие заказы</h3>
                                                 <div id="type" >        
                                                      <table >
                                                                  <tr><td>Телевизор</td><td>Количество</td><td>Цена</td><td>Пользователь</td><td>Дата заказа</td></tr>
                                                         <c:forEach var="order" items="${orders}">
                                                                    <tr>

                                                                    <td><c:out value="${order.producer.name}"/>&nbsp;<c:out value="${order.model.model}"/></td><td><c:out value="${order.amount}"/></td><td><c:out value="${order.price}"/></td><td><c:out value="${order.user.fullName}"/></td><td><c:out value="${order.date}"/></td>
