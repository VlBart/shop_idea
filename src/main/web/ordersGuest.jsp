                                                     ...
                                                     <c:when test="${!empty ord}">
                                                        ...
                                                        <table>
                                                            <c:forEach var="order" items="${ord}">
                                                                <tr>
                                                                <td>${order.producer.name}&nbsp;${order.model.model}</td><td>${order.amount}&nbsp;шт.</td><td>${order.cost}&nbsp;бел.руб</td>
                                                                <td><a href="ActionServlet?command=Basket&action=delete&model=${order.model.model}">Удалить</a></td>
                                                                </tr>
                                                            </c:forEach>
                                                                ...
                                                                <th colspan="4"> 
                                                                <hr/>
                                                                <br><a href="ActionServlet?command=BasketGuest&action=submit">ЗАКАЗАТЬ</a></th>
                                                                </tr>
                                                        </table>
                                                     </c:when>
